...
{
slug: 'gdpr-scanner-full-report',
title: 'Get a Full GDPR Audit Report in 60 Seconds — Free',
description:
'Most GDPR scanners show you a score and leave you guessing. ComplyScan delivers a full GDPR audit report with specific issues and fix steps in under a minute.',
targetKeyword: 'gdpr scanner full report',
secondaryKeywords: [
'GDPR audit report',
...
angle:
'A verbal report fades. A clear written report you can share with your lawyer, boss, or client is actionable. ComplyScan delivers a professional full report with specific fixes.',
ctaText: 'Get your free GDPR report',
ctaUrl: 'https://complyscan.pages.dev',
},
{
...
Run a free GDPR compliance scan on any website — get your full report in minutes.
</p>
<Link
href="${spec.ctaUrl}"
...
<li>Generate a full report with prioritised remediation steps</li>
</ol>
<p>No signup required. No credit card. The free tier gives you 3 scans per month.</p>`,

'gdpr-scanner-full-report': `
<h2>Why a full report matters more than you think</h2>
...
<p>A complete written report changes behaviour. When you can download a formatted, branded compliance report, you\'re more likely to actually read it, act on it, and share it with the people who need to make decisions about your website.</p>
...
<p>ComplyScan\'s full report includes all of the above, plus a website analysis section covering your privacy policy, cookie banner, tracking scripts, and third-party embeds.</p>
...
<h2>Get your report in 60 seconds</h2>
<p>Enter any URL. ComplyScan will scan it, analyse it, and deliver a full report to your browser. No signup, no payment, no waiting for a consultant. Free for up to 3 scans per month.</p>`,
...
<li><strong>White-label compliance reports</strong> — send directly to clients with your branding</li>
